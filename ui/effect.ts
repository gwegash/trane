...
class Effect extends GraphNode {
    ...
    createWetDry(){
        ...
        this.webAudioNodes.wetDryChannelSplitter= this.audioContext.createChannelSplitter(2)
        ...
        this.webAudioNodes.wetDryConstantOne = this.audioContext.createConstantSource()

        this.webAudioNodes.wetDryWetGain.gain.setValueAtTime(0, this.audioContext.currentTime)
        this.webAudioNodes.wetDryDryGain.gain.setValueAtTime(0, this.audioContext.currentTime)

        //Wire everything up
        this.webAudioNodes.wetDryConstantOne.connect(this.webAudioNodes.wetDryPanner)
        this.webAudioNodes.wetDryConstantOne.start()
        this.webAudioNodes.wetDryPanner.connect(this.webAudioNodes.wetDryChannelSplitter)

		//this.webAudioNodes.wetDryPanner.channelCount = 1;
		//this.webAudioNodes.wetDryPanner.channelCountMode = "explicit";

        this.webAudioNodes.wetDryChannelSplitter.connect(this.webAudioNodes.wetDryWetGain.gain, 0)
        this.webAudioNodes.wetDryChannelSplitter.connect(this.webAudioNodes.wetDryDryGain.gain, 1)

        this.webAudioNodes.wetDryWetGain.connect(this.webAudioNodes.wetDryOutputGain)
        this.webAudioNodes.wetDryDryGain.connect(this.webAudioNodes.wetDryOutputGain)
